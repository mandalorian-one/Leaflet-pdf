(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.Leaflet = global.Leaflet || {}, global.Leaflet.ImagePdf = {}), global.jspdf, global.domtoimage, global.changedpi));
})(this, (function (exports, jspdf, domtoimage, changedpi) { 'use strict';
      ...
      var generateImage = function (ev) {
        ...
        imageGenerator(this.map.getContainer(), options).then(function (data) {
          ...
          if (scale > 1 && data instanceof Blob) {
            changedpi.changeDpiBlob(data, this.baseImageDpi * this.pixelRatio).then(function (data) {
              images.push(data);
            ...
            data = changedpi.changeDpiDataUrl(data, this.baseImageDpi * this.pixelRatio);
          }
          images.push(data);
          document.dispatchEvent(new CustomEvent("pdf:startNextImage", {
            detail: {
  ...
  exports.OpCreatePage = OpCreatePage;
  exports.OpGenerateImage = OpGenerateImage;
  exports.OpLoadTiles = OpLoadTiles;
